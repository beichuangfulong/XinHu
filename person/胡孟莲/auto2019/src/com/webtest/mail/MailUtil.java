...
public class MailUtil {
    ...
    static String from = "π€‘√";
    static String user = "2724702423@qq.com";
    static String password = "zhangzhen314280";
    static String to="3052221098@qq.com";
    ...
    public static void main(String args[]) throws UnsupportedEncodingException
    {
    	...
    	MailUtil.sendEmail("3052221098@qq.com", "ceshi", "ce");
