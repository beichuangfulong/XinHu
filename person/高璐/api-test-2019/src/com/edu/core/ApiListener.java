...
//		String toMail=BaseTest.getCfgProperty("to_mail");
//		try {
//			if(this.getFailedTests()!=null&this.getFailedTests().size()!=assertNull(object?)) {
//				MailUtil.sendEmail(toMail,emailTitle, emailContent);
//				log.info("email send to"+toMail+"success");
//			}else {
//				MailUtil.sendEmail(BaseTest.getCfgProperty("success to"));
//				log.info("email send to"+BaseTest.getCfgProperty("success")+"success");
//			}
//			
//		} catch (UnsupportedEncodingException e) {
//			// TODO Auto-generated catch block
